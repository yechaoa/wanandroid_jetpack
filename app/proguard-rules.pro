...
# ------------ okio r8自动注入，ProGuard需要添加------------
# Animal Sniffer compileOnly dependency to ensure APIs are compatible with older versions of Java.
-dontwarn org.codehaus.mojo.animal_sniffer.*

# ------------ retrofit2 r8自动注入，ProGuard需要添加------------
...
# ------------ banner 自带keep ------------
#https://github.com/youth5201314/banner/blob/master/banner/proguard-rules.pro
